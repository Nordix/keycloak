    ...
    public Statement apply(Statement base, Description description) {
        ...
        if (passwordPolicyAnnotations != null) {
            ...
            if (passwordPolicy.mustChange()) {
                ...
                // password changes. The bind DN is overridden to a non-admin account.
                serverProperties.setProperty(LDAPEmbeddedServer.PROPERTY_ENABLE_ACCESS_CONTROL, "false");
                clientConfig.put(LDAPConstants.BIND_DN, "uid=keycloak-admin," + clientConfig.get(LDAPConstants.BASE_DN));
                clientConfig.put(LDAPConstants.BIND_CREDENTIAL, "secret");
            }
        }
